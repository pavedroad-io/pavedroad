{% if security == 'security-standard' %}
# Security Policies and Procedures for the {{organization}} {{project}} project
...
The {{project}} project team and community take all security bugs in the {{project}} project seriously.
Thank you for improving the security of the {{project}} project. We appreciate your efforts and
